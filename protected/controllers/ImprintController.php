...
class ImprintController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Imprint'];
			if($model->save())
	...
	{
		$model=new Imprint('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Imprint']))
			$model->attributes=$_GET['Imprint'];
	...
	{
		$criteria = new CDbCriteria(array('condition'=>'imprint=:imprint','params'=>array(':imprint'=>$imprint)));
		$model=Imprint::model()->find($criteria);
		if($model===null)
			throw new CHttpException(404,'The requested page does not exist.');
		return $model;
	}
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='imprint-form')
		{
